<!-- filepath: /Users/hanif/Magang iNDIEPOOL/absensi/resources/views/admin/users/import-teachers.blade.php -->
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold">Import Guru</h2>
    ...
    <div class="max-w-2xl py-6 mx-auto">
        <div class="p-6 bg-white rounded shadow">
            <div class="mb-4">
                ...
                <p class="mt-1 text-sm text-gray-600">Format Excel dengan header: name, email, nip, password, address,
                    phone</p>
            </div>
